...
const app = express();
const conString = 'postgres://steven:123qwe@localhost:5432/postgres';//for steven's ubuntu
// const conString = 'postgres://localhost:5432/postgres';//for mac // DONE: Don't forget to set your own conString
